                            ...
                            <form @submit.prevent="submitGroup(groupKey)" class="p-6">
                                ...
                                <div class="flex justify-end pt-6 border-t border-gray-200 mt-6">
                                    <button
                                        ...
                                        class="inline-flex items-center px-6 py-3 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                    >
