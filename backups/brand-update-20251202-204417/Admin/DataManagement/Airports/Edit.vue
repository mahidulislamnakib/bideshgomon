        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Airport</h1>
                </div>
...
const form = useForm({
    ...
    is_international: props.airport.is_international,
    is_active: props.airport.is_active,
});
...
const submit = () => {
    form.put(route('admin.data.airports.update', props.airport.id));
};
</script>
