<template>
  ...
  <AdminLayout>
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Edit Degree</h1>
...
const form = useForm({
  ...
  name_bn: props.degree.name_bn,
  short_name: props.degree.short_name,
  level: props.degree.level,
  typical_duration_years: props.degree.typical_duration_years,
  is_active: props.degree.is_active,
});

const submit = () => {
  form.put(route('admin.data.degrees.update', props.degree.id));
};
</script>
