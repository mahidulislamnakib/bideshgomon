        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6">
            <div class="flex items-center justify-between mb-6">
              <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create System Event</h2>
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Use dot notation: category.action</p>
...
const submit = () => {
  form.post(route('admin.data.system-events.store'))
}
</script>
