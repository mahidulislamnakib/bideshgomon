  ...
  <AdminLayout>
    <div class="p-6">
      ...
      <div class="mb-6 flex flex-col sm:flex-row gap-4">
        <Link :href="route('admin.data.bank-names.create')" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700">
      ...
      <div class="mb-6 bg-white rounded-lg shadow p-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input v-model="filters.search" type="text" placeholder="Search banks..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" @input="debounceSearch"/>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Type</label>
            <select v-model="filters.type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" @change="applyFilters">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="bank in bankNames.data" :key="bank.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <Link :href="route('admin.data.bank-names.edit', bank.id)" class="text-blue-600 hover:text-blue-900 mr-3">Edit</Link>
