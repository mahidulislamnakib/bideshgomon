<template>
  <Head title="Bulk Upload Service Categories" />
  <AdminLayout>
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Bulk Upload Service Categories</h1>
        <p class="mt-1 text-sm text-gray-600">Upload multiple service categories using CSV file</p>
      </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <div class="flex gap-2">
              <a :href="route('admin.data.service-categories.template')" class="inline-flex items-center px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-md hover:bg-gray-200">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Empty Template
              </a>
              <a :href="route('admin.data.service-categories.template', { with_sample: 1 })" class="inline-flex items-center px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-md hover:bg-gray-200">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
          ...
          <div class="space-y-4 text-sm">
            ...
            <div>
              ...
              <ul class="list-disc list-inside text-gray-600 space-y-1">
                ...
                <li><strong>icon</strong> - Icon class (e.g., DocumentTextIcon)</li>
                <li><strong>description</strong> - Brief description</li>
                <li><strong>color</strong> - Hex color code (e.g., #3B82F6)</li>
                <li><strong>sort_order</strong> - Display order number (0-999)</li>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
              ...
              <ul class="list-disc list-inside text-blue-800 text-xs space-y-1">
                ...
                <li>Sort order determines display sequence (lower = first)</li>
            ...
            <div>
              ...
              <pre class="bg-gray-50 border border-gray-200 rounded p-2 text-xs overflow-x-auto">name,slug,icon,description,color,sort_order,is_active
Visa Services,visa-services,DocumentTextIcon,Complete visa application services,#3B82F6,1,1
Travel Services,travel-services,GlobeAltIcon,Flight and hotel booking,#10B981,2,1
Documentation,documentation,ClipboardDocumentListIcon,Document services,#F59E0B,3,1</pre>
            </div>
          </div>
        </div>
      </div>
...
const submit = () => {
  form.post(route('admin.data.service-categories.process-upload'), {
    onSuccess: () => {
      form.reset();
    },
  });
