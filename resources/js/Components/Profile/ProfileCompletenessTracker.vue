...
const getColorClasses = (color, type = 'bg') => {
    const colors = {
        blue: { bg: 'bg-growth-600', text: 'text-growth-600', border: 'border-blue-500', ring: 'ring-blue-500' },
            ...
            >
                <div class="flex items-start justify-between">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <h5 class="font-medium text-gray-900 group-hover:text-growth-600 transition-colors">
                                {{ section.name }}
                            </h5>
