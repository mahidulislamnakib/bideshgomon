...
const fetchFamilyMembers = async () => {
    try {
        const response = await axios.get(route('api.profile.family.index'))
...
const saveFamilyMember = () => {
    ...
    if (editingMember.value) {
        ...
        axios.post(route('api.profile.family.update', editingMember.value.id), formData, {
        ...
        axios.post(route('api.profile.family.store'), formData, {
            headers: { 'Content-Type': 'multipart/form-data' }
        })
        .then(() => {
            showModal.value = false
...
const deleteFamilyMember = () => {
    ...
    axios.delete(route('api.profile.family.destroy', deletingMember.value.id))
        .then(() => {
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form @submit.prevent="saveFamilyMember" class="px-6 py-4 space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select v-model="form.relationship" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600">
                            ...
                            <div>
                                ...
                                <input v-model="form.full_name" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                                <p v-if="form.errors.full_name" class="mt-1 text-sm text-red-600">{{ form.errors.full_name }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Date of Birth *</label>
                                <input v-model="form.date_of_birth" type="date" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            ...
                            <div>
                                ...
                                <input v-model="form.place_of_birth" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Gender *</label>
                                <select v-model="form.gender" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600">
                            ...
                            <div>
                                ...
                                <input v-model="form.nationality" type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.current_country" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Current City</label>
                                <input v-model="form.current_city" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.occupation" type="text" :disabled="form.is_dependent" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600 disabled:bg-gray-100" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Employer</label>
                                <input v-model="form.employer" type="text" :disabled="form.is_dependent" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600 disabled:bg-gray-100" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Annual Income (৳)</label>
                                <input v-model="form.annual_income_bdt" type="number" step="0.01" :disabled="form.is_dependent" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600 disabled:bg-gray-100" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Education Level</label>
                                <select v-model="form.education_level" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600">
                            ...
                            <div>
                                ...
                                <select v-model="form.marital_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input v-model="form.is_dependent" type="checkbox" class="h-4 w-4 text-growth-600 focus:ring-growth-600 border-gray-300 rounded" />
                            ...
                            <div class="flex items-center">
                                <input v-model="form.lives_with_user" type="checkbox" class="h-4 w-4 text-growth-600 focus:ring-growth-600 border-gray-300 rounded" />
                                <label class="ml-2 block text-sm text-gray-900">
                                    Lives with me
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input v-model="form.will_accompany_travel" type="checkbox" class="h-4 w-4 text-growth-600 focus:ring-growth-600 border-gray-300 rounded" />
                                <label class="ml-2 block text-sm text-gray-900">
                            ...
                            <div class="flex items-center">
                                <input v-model="form.emergency_contact" type="checkbox" class="h-4 w-4 text-growth-600 focus:ring-growth-600 border-gray-300 rounded" />
                                <label class="ml-2 block text-sm text-gray-900">
                                    Emergency Contact
                                </label>
                            </div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.passport_number" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Visa Status</label>
                                <select v-model="form.visa_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input v-model="form.deceased" type="checkbox" class="h-4 w-4 text-growth-600 focus:ring-growth-600 border-gray-300 rounded" />
                                <label class="ml-2 block text-sm text-gray-900">
                                    Deceased
                                </label>
                            </div>
                            ...
                            <div v-if="form.deceased">
                                ...
                                <input v-model="form.deceased_date" type="date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.contact_phone" type="tel" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" placeholder="+880 1XXX-XXXXXX" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Contact Email</label>
                                <input v-model="form.contact_email" type="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        <button
                            ...
                            class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-growth-600 hover:bg-growth-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 disabled:opacity-50"
                        >
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button
                        ...
                        class="px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-red-600 hover:bg-growth-700"
                    >
                        Delete
                    </button>
                </div>
