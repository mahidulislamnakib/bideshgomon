  ...
  <div :class="`col-span-12 md:col-span-${field.column_width || 12}`">
    ...
    <div v-else-if="field.field_type === 'textarea'" class="space-y-1">
      ...
      <textarea
        ...
        :maxlength="field.max_length"
        :rows="field.rows || 4"
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-growth-600"
      />
      <p v-if="field.help_text" class="text-xs text-gray-500 mt-1">
        {{ field.help_text }}
      </p>
      ...
      <div class="space-y-2">
        ...
        >
          <input
            ...
            v-model="fieldValue"
            :required="field.is_required"
            class="rounded-full border-gray-300 text-growth-600 shadow-sm focus:border-primary-500 focus:ring-growth-600"
          />
    ...
    <div v-else-if="field.field_type === 'checkbox'" class="space-y-2">
      <label class="flex items-center space-x-2">
        <input
          ...
          v-model="fieldValue"
          :required="field.is_required"
          class="rounded border-gray-300 text-growth-600 shadow-sm focus:border-primary-500 focus:ring-growth-600"
        />
