    ...
    <div class="relative w-full" ref="searchContainer">
        ...
        <div class="relative">
            <input
                ...
                class="block w-full px-4 pr-32 sm:pr-36 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 focus:ring-2 focus:ring-growth-600 focus:border-transparent transition-all text-sm truncate"
            />
            <div class="absolute inset-y-0 right-1 flex items-center gap-1">
                ...
                <button
                    @click="toggleFilters"
                    type="button"
                    class="p-2 text-gray-500 hover:text-growth-600 dark:text-gray-400 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all duration-200 flex-shrink-0"
                ...
                <button
                    ...
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-growth-600 hover:bg-growth-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white text-xs sm:text-sm font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex-shrink-0"
                >
