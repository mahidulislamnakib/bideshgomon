        ...
        <div class="min-h-screen bg-gray-50 py-12">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-12">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-growth-600 rounded-full mb-6">
                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-bold text-growth-600">{{ completionPercentage }}%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                            <div 
                                class="bg-growth-600 h-3 rounded-full transition-all duration-500"
                        ...
                        >
                            <div class="flex items-center gap-3 mb-4">
                                <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center">
                                    <component :is="step.icon" class="h-6 w-6 text-growth-600" />
                                </div>
                                <div class="w-8 h-8 bg-growth-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                                    {{ index + 1 }}
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                >
                                    <span class="w-1 h-1 bg-growth-600 rounded-full"></span>
                                    {{ field }}
                                </div>
                            </div>
                        </div>
                ...
                <!-- CTA Buttons -->
                <div class="bg-growth-600 rounded-2xl p-8 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <button
                            ...
                            class="inline-flex items-center px-8 py-4 bg-white text-growth-600 rounded-xl font-bold text-lg hover:bg-gray-50 transform hover:scale-105 transition shadow-lg"
                        >
                        ...
                        <button
                            @click="skipForNow"
                            class="inline-flex items-center px-8 py-4 bg-growth-600 text-white rounded-xl font-semibold text-lg hover:bg-indigo-400 transition"
                        >
                            I'll Do This Later
                        </button>
                    </div>
                ...
                <div class="mt-12 grid grid-cols-3 gap-6 max-w-3xl mx-auto">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-growth-600 mb-1">95%</div>
