...
const saveChanges = async () => {
    ...
    try {
        await axios.put(route('api.attestation-applications.update', props.application.id), form.value);
...
const deleteApplication = async () => {
    if (confirm('Are you sure you want to delete this application? This action cannot be undone.')) {
        try {
            await axios.delete(route('api.attestation-applications.destroy', props.application.id));
            router.visit(route('profile.attestation.index'));
        } catch (error) {
...
<template>
    <Head title="Attestation Application Details" />
        ...
        <div class="py-6 sm:py-12">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 sm:mb-8">
                    <Link
                        :href="route('profile.attestation.index')"
