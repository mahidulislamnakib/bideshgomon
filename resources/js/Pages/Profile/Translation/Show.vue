...
const saveChanges = async () => {
    ...
    try {
        await axios.put(route('api.translation-applications.update', props.application.id), form.value);
...
const deleteApplication = async () => {
    if (confirm('Are you sure you want to delete this application? This action cannot be undone.')) {
        try {
            await axios.delete(route('api.translation-applications.destroy', props.application.id));
            router.visit(route('profile.translation.index'));
        } catch (error) {
...
<template>
    <Head title="Translation Application Details" />
        ...
        <div class="py-6 sm:py-12">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 sm:mb-8">
                    <Link
                        :href="route('profile.translation.index')"
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col-reverse sm:flex-row gap-3 sm:justify-between">
                        ...
                        <div class="flex flex-col-reverse sm:flex-row gap-3">
                            ...
                            <button
                                ...
                                @click="toggleEdit"
                                class="inline-flex items-center justify-center px-6 py-2 bg-growth-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-growth-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 transition-colors"
                            >
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
