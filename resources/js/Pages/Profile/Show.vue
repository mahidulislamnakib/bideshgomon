...
const getRiskLevel = () => {
    ...
    if (score >= 25) return { text: 'Low Risk', color: 'text-growth-600 bg-blue-50' };
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-rhythm-lg">
                ...
                <div id="phones" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div class="flex items-center gap-3 flex-1 min-w-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <a :href="`tel:${phone.country_code}${phone.phone_number}`" class="text-base font-semibold text-gray-900 dark:text-gray-100 hover:text-growth-600 dark:hover:text-sky-400">
                                    ...
                                    <div class="flex flex-col items-end gap-1">
                                        <span v-if="phone.is_primary" class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-growth-600 text-white">
                                            Primary
                                        </span>
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'phone' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="education" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'education' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Education
                ...
                <div id="experience" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <Link :href="route('profile.edit', { section: 'experience' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
                            Add Experience
                ...
                <div id="skills" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-if="skills && skills.length > 0" class="space-y-3">
                            <div v-for="userSkill in skills" :key="userSkill.id" class="bg-teal-50 border border-teal-200 rounded-lg p-4">
                                <div class="flex justify-between items-start mb-2">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-growth-600 text-white capitalize">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'skills' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Skills
                ...
                <div id="travel" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-if="travelHistory && travelHistory.length > 0" class="space-y-3">
                            <div v-for="travel in travelHistory" :key="travel.id" class="bg-sky-50 border border-sky-200 rounded-lg p-4">
                                <div class="flex justify-between items-start mb-3">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-growth-600 text-white capitalize flex-shrink-0">
                                        {{ travel.purpose }}
                                    </span>
                                </div>
                                <dl class="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'travel' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Travel History
                ...
                <div id="address" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'address' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Address
                ...
                <div id="documents" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'documents' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Documents
                ...
                <div id="family" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'family' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Family Member
                ...
                <div id="financial" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'financial' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Financial Info
                ...
                <div id="languages" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'languages' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Language
                ...
                <div id="security" class="bg-white dark:bg-gray-800 shadow-md sm:rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 scroll-mt-20">
                    ...
                    <div class="p-4 sm:p-6">
                                        ...
                                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                            <div 
                                                ...
                                                :class="{
                                                    ...
                                                    'bg-growth-600': securityInformation.risk_score >= 25 && securityInformation.risk_score < 50,
                        ...
                        <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                            ...
                            <Link :href="route('profile.edit', { section: 'security' })" class="inline-flex items-center gap-2 px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors touch-manipulation">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Add Security Info
