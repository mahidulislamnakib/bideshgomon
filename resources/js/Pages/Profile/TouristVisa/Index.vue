        ...
        <div class="py-6 sm:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                ...
                                <div class="flex sm:flex-col gap-2 w-full sm:w-auto">
                                    <Link
                                        ...
                                        class="flex-1 sm:flex-initial inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 transition-colors"
                                    >
                                        View Details
                                    </Link>
                                    <button
                ...
                <div v-else class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
                    ...
                    <Link
                        :href="route('profile.tourist-visa.create')"
                        class="mt-6 inline-flex items-center justify-center px-6 py-3 bg-growth-600 border border-transparent rounded-lg font-semibold text-white hover:bg-growth-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 transition-colors"
                    >
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
