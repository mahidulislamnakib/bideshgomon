                ...
                <form @submit.prevent="submit" class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="p-6 sm:p-8 space-y-6">
                        <div>
                            ...
                            <select v-model="form.destination_country_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" required>
                        ...
                        <div>
                            ...
                            <select v-model="form.education_level" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" required>
                        ...
                        <div>
                            ...
                            <select v-model="form.study_field" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.institution_name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" placeholder="e.g., Harvard University">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.course_name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" placeholder="e.g., Master of Computer Science">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" v-model="form.intended_start_date" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="number" v-model="form.course_duration_months" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" min="1" placeholder="e.g., 24">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" v-model="form.has_admission_letter" class="rounded border-gray-300 text-brand-red-600 focus:ring-brand-red-600">
                                <span class="ml-2 text-sm text-gray-700">I have an admission letter</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" v-model="form.has_ielts_toefl" class="rounded border-gray-300 text-brand-red-600 focus:ring-brand-red-600">
                        ...
                        <div v-if="form.has_ielts_toefl" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select v-model="form.english_test_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="text" v-model="form.english_test_score" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" placeholder="e.g., 7.5 or 100">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="form.previous_education_gpa" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500" placeholder="e.g., 3.8 or A">
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
                        <Link :href="route('profile.student-visa.index')" class="inline-flex items-center justify-center px-6 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-red-600 transition-colors">
                            Cancel
                        </Link>
                        <button type="submit" :disabled="form.processing" class="inline-flex items-center justify-center px-6 py-2 bg-brand-red-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
