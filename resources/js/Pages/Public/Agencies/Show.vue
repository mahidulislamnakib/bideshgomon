    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <!-- Breadcrumb -->
                <div class="mb-6">
                    <Link :href="route('agencies.index')" class="text-growth-600 hover:text-red-900">
                        ← Back to Agencies
                    </Link>
                </div>
                        ...
                        <div class="flex items-start space-x-6">
                            <div class="flex-shrink-0">
                                ...
                                <div v-else class="h-24 w-24 bg-indigo-100 rounded-lg flex items-center justify-center">
                                    <BuildingOfficeIcon class="h-12 w-12 text-growth-600" />
                                </div>
                            </div>
                            <div>
                                <div class="flex items-center space-x-2">
                                    <h1 class="text-3xl font-bold text-gray-900">{{ agency.name }}</h1>
                                    <CheckBadgeIcon v-if="agency.is_verified" class="h-7 w-7 text-growth-600" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <UsersIcon class="h-12 w-12 text-growth-600" />
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div v-for="member in teamMembers" :key="member.id" class="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                                    <div class="flex-shrink-0">
                                        ...
                                        <div v-else class="h-16 w-16 rounded-full bg-indigo-100 flex items-center justify-center">
                                            <UserIcon class="h-8 w-8 text-growth-600" />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div v-if="$page.props.auth.user" class="mb-6 p-4 bg-gray-50 rounded-lg">
                                ...
                                <form @submit.prevent="submitReview" class="space-y-4">
                                    ...
                                    <button
                                        ...
                                        class="px-4 py-2 bg-growth-600 text-white rounded-md hover:bg-growth-700 disabled:opacity-50"
                                    >
                                    ...
                                    <div class="flex items-start space-x-3">
                                        <div class="flex-shrink-0">
                                            <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                                <span class="text-sm font-semibold text-growth-600">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <div class="space-y-3">
                                <a v-if="agency.email" :href="`mailto:${agency.email}`" class="flex items-center text-gray-700 hover:text-growth-600">
                                    <EnvelopeIcon class="h-5 w-5 mr-3 text-gray-400" />
                                    <span class="text-sm">{{ agency.email }}</span>
                                </a>

                                <a v-if="agency.phone" :href="`tel:${agency.phone}`" class="flex items-center text-gray-700 hover:text-growth-600">
                                    <PhoneIcon class="h-5 w-5 mr-3 text-gray-400" />
                                    <span class="text-sm">{{ agency.phone }}</span>
                                </a>

                                <a v-if="agency.whatsapp" :href="`https://wa.me/${(agency.whatsapp || '').replace(/[^0-9]/g, '')}`" target="_blank" class="flex items-center text-gray-700 hover:text-growth-600">
                                ...
                                <a v-if="agency.website" :href="agency.website" target="_blank" class="flex items-center text-gray-700 hover:text-growth-600">
                        ...
                        >
                            <div class="flex items-center space-x-4 mb-3">
                                ...
                                <div v-else class="h-12 w-12 bg-indigo-100 rounded-lg flex items-center justify-center">
                                    <BuildingOfficeIcon class="h-6 w-6 text-growth-600" />
                                </div>
                                <div>
