                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-4">
                        <div class="text-center">
                            <!-- Price -->
                            <div class="text-4xl font-bold text-growth-600 mb-2">
                            ...
                            <button
                                ...
                                class="w-full bg-growth-600 hover:bg-growth-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition-colors duration-200"
                            >
                                Book Now
                            </button>
                            ...
                            <a
                                href="#"
                                class="block mt-4 text-sm text-growth-600 hover:text-sky-700 font-medium"
                            >
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <Link
                                    ...
                                    class="text-growth-600 hover:text-sky-700 font-medium"
                                >
