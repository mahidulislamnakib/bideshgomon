...
<template>
    ...
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header Card -->
            <div class="bg-growth-600 rounded-xl shadow-lg overflow-hidden mb-8 border-2 border-blue-700">
            ...
            <div v-if="hasBasicInfo" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <UserIcon class="h-6 w-6 text-growth-600 mr-3" />
            ...
            <div v-if="hasEducation" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <AcademicCapIcon class="h-6 w-6 text-growth-600 mr-3" />
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        <div v-for="(edu, index) in profile.education" :key="index" class="border-l-4 border-indigo-500 pl-4">
                            ...
                            <p class="text-growth-600 font-medium">{{ edu.institution_name }}</p>
            ...
            <div v-if="hasWorkExperience" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <BriefcaseIcon class="h-6 w-6 text-growth-600 mr-3" />
            ...
            <div v-if="hasLanguages" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <ChatBubbleLeftRightIcon class="h-6 w-6 text-growth-600 mr-3" />
            ...
            <div v-if="hasSocialLinks" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <ShareIcon class="h-6 w-6 text-growth-600 mr-3" />
            ...
            <div v-if="hasTravelHistory" class="bg-white rounded-lg shadow mb-6">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        <GlobeAltIcon class="h-6 w-6 text-growth-600 mr-3" />
            ...
            <div class="text-center py-8 text-gray-500">
                <p>Powered by <span class="font-semibold text-growth-600">BideshGomon</span></p>
