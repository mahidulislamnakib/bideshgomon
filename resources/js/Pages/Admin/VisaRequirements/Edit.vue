            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Visa Requirement</h1>
                            <p class="mt-2 text-gray-600 dark:text-gray-400">Update visa requirement for {{ visaRequirement.country }}</p>
                        </div>
                    ...
                    <form @submit.prevent="submitForm">
                        <div class="p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-growth-600 focus:ring-growth-600"
                                        />
                                        <p v-if="form.errors.country_code" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ form.errors.country_code }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p v-if="form.errors.visa_type" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ form.errors.visa_type }}</p>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">General Requirements *</label>
                                        <textarea 
                                            ...
                                            class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-growth-600 focus:ring-growth-600"
                                        />
                                        <p v-if="form.errors.general_requirements" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ form.errors.general_requirements }}</p>
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Important Notes</label>
                                        <textarea 
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center">
                                        <input 
                                            ...
                                            type="checkbox"
                                            class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-growth-600 focus:ring-growth-600"
                                        />
                        ...
                        <!-- Form Actions -->
                        <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 flex justify-between rounded-b-lg">
                            <button 
                                type="button"
                                @click="confirmDelete"
