        ...
        <div v-else class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8 flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Service Modules Management</h1>
                        <p class="mt-2 text-gray-600 dark:text-gray-400">Manage all 39 services across 6 categories</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900 dark:text-white">{{ stats.total_services }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900 dark:text-white">{{ stats.active_services }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Coming Soon</dt>
                                    <dd class="text-2xl font-semibold text-gray-900 dark:text-white">{{ stats.coming_soon }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900 dark:text-white">{{ stats.total_applications }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div v-show="expandedCategories.includes(category.id)" class="px-6 pb-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                <div 
                                    ...
                                    :key="service.id"
                                    class="border rounded-2xl p-4 hover:shadow-md transition-shadow relative"
                                    :class="{ 
                                        'border-green-300 bg-green-50 dark:bg-green-900/20 dark:border-green-700': service.is_active && !service.coming_soon,
                                        'border-yellow-300 bg-yellow-50 dark:bg-yellow-900/20 dark:border-yellow-700': service.coming_soon,
                                        'border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600': !service.is_active && !service.coming_soon
                                    }"
                                >
                                    ...
                                    <!-- Service Info -->
                                    <div class="mt-6">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">{{ service.name }}</h3>
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">{{ service.short_description }}</p>
                                        ...
                                        <div class="flex gap-2">
                                            <Link
                                                ...
                                                class="flex-1 px-3 py-2 text-sm font-medium text-white rounded-xl text-center"
                                                :style="{ backgroundColor: category.color }"
                                            >
                                                View Details
                                            </Link>
                                            <button
                                                ...
                                                class="px-3 py-2 text-sm font-medium rounded-xl border"
                                        ...
                                        <!-- Implementation Info -->
                                        <div v-if="service.controller" class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
