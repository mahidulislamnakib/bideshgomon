                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                <Link :href="route('admin.master-documents.show', document.id)" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-2xl transition">
                                    View
                                </Link>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                                <button
                                    ...
                                    class="px-6 py-2 bg-red-600 hover:bg-growth-700 text-white rounded-2xl transition"
                                >
                                    Delete Document
                                </button>
                                <div class="flex items-center space-x-3">
                                    <Link :href="route('admin.master-documents.show', document.id)" class="px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-2xl transition">
                                        Cancel
                                    </Link>
                                    <button
                                        type="submit"
