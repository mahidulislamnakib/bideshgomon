...
const getStatusColor = (status) => {
    const colors = {
        ...
        shortlisted: 'bg-red-100 text-growth-600',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <StarIcon class="h-6 w-6 text-growth-600 mr-2" />
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all">
                        <div class="flex items-center justify-between mb-4">
                            <div class="p-3 bg-red-100 rounded-lg">
                                <BriefcaseIcon class="h-8 w-8 text-growth-600" />
                            </div>
                        ...
                        <p class="text-3xl font-extrabold text-growth-600 mb-4">{{ jobApplicationStats.total }}</p>
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-semibold text-growth-600">{{ jobApplicationStats.shortlisted }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                        ...
                        <Link
                            ...
                            class="block w-full text-center bg-growth-600 text-white px-4 py-2 rounded-lg hover:bg-growth-700 transition-colors font-medium"
                        >
                            Manage Applications
                        </Link>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all">
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-semibold text-growth-600">{{ publicProfileStats.average_views_per_profile }}</span>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                        <div class="flex items-center justify-between mb-3">
                            <div class="p-2 bg-sky-100 rounded-lg">
                                <PaperAirplaneIcon class="h-6 w-6 text-growth-600" />
                            </div>
                            <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded">
                                +{{ flightStats.today }}
                            </span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        <BriefcaseIcon class="h-5 w-5 text-growth-600 mr-2" />
                        Recent Job Applications
                    </h3>
                    <div class="space-y-3">
                        <div
                            ...
                            :key="application.id"
                            class="border-l-4 border-growth-600 pl-3 py-2"
                        >
                    ...
                    <div class="space-y-3">
                        ...
                        >
                            ...
                            <a
                                ...
                                target="_blank"
                                class="text-xs text-growth-600 hover:underline"
                            >
                                View Profile ?
                            </a>
                        </div>
