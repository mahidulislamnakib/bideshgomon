    ...
    <AdminLayout title="Create Partner">
        <div class="py-6">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6">
                    <Link :href="route('admin.partners.index')" class="inline-flex items-center text-sm text-brand-red-600 hover:text-primary-800">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-primary-400 transition-colors">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-brand-red-600 hover:text-primary-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-transparent"
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <button
                                ...
                                :class="form.is_active ? 'bg-brand-red-600' : 'bg-gray-200'"
                        ...
                        <div class="flex justify-end space-x-3 pt-4 border-t">
                            ...
                            <button type="submit" :disabled="form.processing" class="px-4 py-2 bg-brand-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
