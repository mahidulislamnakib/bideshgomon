...
const getStatusColor = (status) => {
  const colors = {
    ...
    scheduled: 'bg-red-100 text-brand-red-600 dark:bg-blue-900/30 dark:text-blue-300',
...
const getTypeIcon = (type) => {
  const icons = {
    email: { component: EnvelopeIcon, color: 'text-brand-red-600' },
      ...
      <div class="bg-white rounded-lg shadow-sm p-4">
        <div class="flex items-center mb-2">
          <div class="p-2 bg-red-100 rounded-lg mr-3">
            <ChartBarIcon class="w-5 h-5 text-brand-red-600" />
          </div>
              ...
              <div class="flex items-center">
                ...
                <div>
                  <Link
                    ...
                    class="text-sm font-medium text-gray-900 hover:text-brand-red-600"
                  >
                    {{ campaign.name }}
                  </Link>
                </div>
