  ...
  <AdminLayout>
          ...
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-3">
              <div class="p-3 bg-red-100 rounded-2xl">
                <PlusIcon class="w-8 h-8 text-growth-600" />
              </div>
              <h1 class="text-4xl font-bold text-gray-900 dark:text-white tracking-tight">Create Campaign</h1>
            </div>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto -mt-8">
      <Card class="overflow-hidden shadow-xl">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <label
              ...
              :key="type"
              :class="[
                'flex items-center justify-center p-5 border-2 rounded-2xl cursor-pointer transition-all',
                form.type === type
                  ? 'border-growth-600 bg-red-50 shadow-md'
        ...
        <div>
          ...
          <div class="space-y-3">
            <label
              ...
              :key="type"
              :class="[
                'flex flex-wrap items-start p-5 border-2 rounded-2xl cursor-pointer transition-all',
        ...
        <div v-if="form.audience_type === 'segment'" class="bg-red-50 p-6 rounded-2xl border-2 border-red-200">
          <div class="flex items-center gap-2 mb-5">
            <svg class="w-6 h-6 text-growth-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-2xl focus:ring-2 focus:ring-growth-600"
                >
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                  <input
                    ...
                    max="100"
                    placeholder="Min (18)"
                    class="px-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-2xl focus:ring-2 focus:ring-growth-600"
                  />
                  <input
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="clicked">Clicked Email Links</option>
          ...
          <div class="mt-5 p-4 bg-red-50 dark:bg-blue-900/30 rounded-2xl border border-red-200 dark:border-blue-800">
        ...
        <div v-if="form.is_ab_test" class="bg-yellow-50 border-2 border-yellow-300 rounded-2xl p-6">
        ...
        <div class="flex flex-wrap justify-end gap-4 pt-6 border-t-2 border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            class="px-8 py-3.5 bg-growth-600 hover:bg-growth-700 text-white rounded-2xl transition-all shadow-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
