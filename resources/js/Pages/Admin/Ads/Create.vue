                ...
                <form @submit.prevent="submit" class="p-8 space-y-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div v-if="imagePreview" class="relative">
                                ...
                                <button
                                    type="button"
                                    @click="removeImage"
                                    class="absolute top-2 right-2 p-1.5 bg-red-600 text-white rounded-full hover:bg-growth-700 transition-colors"
                                >
                    ...
                    <div>
                        <button
                            ...
                            class="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-white hover:text-red-600 transition-colors"
                        >
