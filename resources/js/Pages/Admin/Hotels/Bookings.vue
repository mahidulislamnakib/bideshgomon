...
const getStatusColor = (status) => {
    const colors = {
        ...
        confirmed: 'bg-red-100 text-growth-600',
...
const getPaymentStatusColor = (status) => {
    const colors = {
        ...
        partially_paid: 'bg-red-100 text-growth-600',
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 p-6">
                        <div class="bg-red-50 p-4 rounded-2xl">
                            <div class="text-growth-600 text-xs font-medium">Total</div>
                        ...
                        <div class="bg-red-50 p-4 rounded-2xl">
                            <div class="text-growth-600 text-xs font-medium">Confirmed</div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl">
                            ...
                            <div class="text-xl font-bold text-gray-900 dark:text-gray-100">{{ stats.completed }}</div>
                        </div>
                        <div class="bg-red-50 p-4 rounded-2xl">
                    ...
                    <div class="p-6">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="booking in bookings.data" :key="booking.id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ booking.guest_name }}</div>
                                            <div class="text-sm text-gray-500">{{ booking.guest_email }}</div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ booking.hotel?.name }}</div>
                        ...
                        <div v-if="bookings.links.length > 3" class="mt-6 flex justify-center gap-2">
                            <Link
                                ...
                                :key="index"
                                :href="link.url"
                                :class="link.active ? 'bg-growth-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100'"
