            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ country.name }}</h1>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow mb-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Common Documents (All Applicants)</h3>
                            <div v-if="getRequirementsByType(selectedVisaType).length > 0" class="space-y-3">
                                ...
                                >
                                    <div class="flex items-center flex-1">
                                        ...
                                        <div class="flex-1">
                                            <div class="font-medium text-gray-900 dark:text-white">{{ req.document.document_name }}</div>
                                            <div class="text-sm text-gray-600 mt-1">
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-growth-600">
                        ...
                        <div v-for="profession in professions" :key="profession" class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ profession }}</h3>
                            <div v-if="getRequirementsByType(selectedVisaType, profession).length > 0" class="space-y-3">
                                <div
                                    ...
                                    :key="req.id"
                                    class="flex items-center justify-between p-4 bg-red-50 rounded-2xl"
                                >
                                    <div class="flex items-center flex-1">
                            ...
                            <div v-else class="text-center py-8 text-gray-500 border-2 border-dashed border-gray-200 rounded-2xl">
                ...
                <div v-if="showAssignModal" class="fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4">
                        ...
                        <div class="relative bg-white dark:bg-gray-800 rounded-2xl max-w-4xl w-full p-6 shadow-xl">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Assign Documents to {{ country.name }}</h3>
                            
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Visa Type</label>
                                    <select v-model="selectedVisaType" class="w-full border-gray-300 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <select v-model="selectedProfession" class="w-full border-gray-300 rounded-xl">
                            ...
                            <div class="max-h-96 overflow-y-auto mb-4">
                                <div v-for="category in categories" :key="category.id" class="mb-6">
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">{{ category.name }}</h4>
                                    <div class="space-y-2">
                                        <label
                                            v-for="doc in category.documents"
                                            :key="doc.id"
                                            class="flex items-center p-3 border rounded-2xl hover:bg-gray-50 cursor-pointer"
                                        >
                                            <input
                                                type="checkbox"
                                                :value="doc.id"
                                            ...
                                            <div class="ml-3 flex-1">
                                                <div class="font-medium text-gray-900 dark:text-white">{{ doc.document_name }}</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-400">{{ doc.description }}</div>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    class="px-4 py-2 bg-growth-600 text-white rounded-xl hover:bg-growth-700 disabled:opacity-50"
                                >
