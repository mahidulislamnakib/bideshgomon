            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div class="flex items-start justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-brand-red-600">
                                        {{ country.name }}
                                    </h3>
                                    <p class="text-sm text-gray-500">{{ country.iso_code_2 }}</p>
                                </div>
                            </div>
                            <ArrowRightIcon class="w-5 h-5 text-gray-400 group-hover:text-brand-red-600 transition-colors" />
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <div class="text-brand-red-600 font-medium group-hover:underline">
                                    Manage →
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 bg-red-50 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            <DocumentTextIcon class="w-6 h-6 text-brand-red-600 mr-3" />
                            <div>
                        ...
                        <Link
                            ...
                            class="flex items-center p-4 bg-white rounded-lg hover:shadow-md transition-shadow"
                        >
                            <GlobeAltIcon class="w-6 h-6 text-brand-red-600 mr-3" />
                            <div>
