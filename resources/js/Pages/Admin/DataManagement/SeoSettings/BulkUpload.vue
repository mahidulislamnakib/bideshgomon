                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-gray-400 dark:hover:border-gray-500">
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                            <label for="file-upload" class="relative cursor-pointer rounded-md font-medium text-growth-600 dark:text-blue-400 hover:text-growth-600">
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-growth-600 hover:bg-growth-700 disabled:opacity-50"
                                >
