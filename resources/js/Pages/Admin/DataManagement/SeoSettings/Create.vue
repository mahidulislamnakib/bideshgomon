    ...
    <AdminLayout>
        <div class="px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create SEO Setting</h1>
                <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Add SEO metadata for a new page type.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    >
                        ...
                        <span v-else>Create SEO Setting</span>
                    </button>
                </div>
            </form>
        </div>
...
const submit = () => {
    form.post(route('admin.data.seo-settings.store'))
}
</script>
