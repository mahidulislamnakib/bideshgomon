        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Currency</h1>
                </div>
                ...
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">1 {{ form.code }} = {{ form.exchange_rate_to_bdt }} BDT</p>
                        </div>
...
const form = useForm({
    ...
    exchange_rate_to_bdt: props.currency.exchange_rate_to_bdt,
    is_active: props.currency.is_active,
});

const submit = () => {
    form.put(route('admin.data.currencies.update', props.currency.id));
};
</script>
