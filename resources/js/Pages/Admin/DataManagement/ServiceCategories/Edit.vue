    ...
    <div class="p-6">
      ...
      <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
        ...
        <div v-if="serviceCategory.modules_count > 0" class="mb-4 bg-red-50 border border-red-200 rounded-md p-3">
          <p class="text-sm text-growth-600">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="mb-4">
            ...
            <input v-model="form.slug" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-growth-600 focus:border-growth-600" placeholder="e.g., visa-services"/>
