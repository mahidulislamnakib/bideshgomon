  ...
  <AdminLayout>
    <div class="p-6">
      ...
      <div class="mb-6 flex flex-col sm:flex-row gap-4">
        <Link :href="route('admin.data.service-categories.create')" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="category in serviceCategories.data" :key="category.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <Link :href="route('admin.data.service-categories.edit', category.id)" class="text-blue-600 hover:text-blue-900 mr-3">Edit</Link>
