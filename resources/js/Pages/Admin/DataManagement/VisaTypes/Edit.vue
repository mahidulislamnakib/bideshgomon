      ...
      <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
        <form @submit.prevent="submit">
          ...
          <div class="mb-4">
            ...
            <textarea v-model="form.description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-brand-red-600 focus:border-brand-red-600"></textarea>
