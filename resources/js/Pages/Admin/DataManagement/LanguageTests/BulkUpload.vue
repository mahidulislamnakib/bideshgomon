<template>
    <AdminLayout>
        <Head title="Bulk Upload Language Tests" />
        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Bulk Upload Language Tests</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Upload multiple language tests at once using a CSV file</p>
                </div>
                ...
                <div class="bg-red-50 dark:bg-blue-900/20 border border-red-200 dark:border-blue-800 rounded-lg p-6 mb-6">
                    ...
                    <ol class="list-decimal list-inside space-y-2 text-sm text-growth-600 dark:text-blue-300">
                        <li>Download the CSV template below</li>
                        <li>Fill in your language test data following the format</li>
                        <li>Use language_code column to link tests to languages (e.g., "en" for English)</li>
                        <li>Upload the completed CSV file</li>
                        <li>Review any errors and fix them</li>
                        <li>Successfully uploaded language tests will appear in the list</li>
                    </ol>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">language_tests_template.csv</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">CSV template with sample data</p>
                        </div>
                        <a
                            :href="route('admin.data.language-tests.template')"
                    ...
                    <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded text-xs font-mono">code*</span>
                            <span class="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded text-xs font-mono">score_type*</span>
                        </div>
                        <p class="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2 mt-3">Optional Columns:</p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">language_code</span>
                            ...
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">min_score</span>
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">max_score</span>
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">description</span>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-3">
                            <strong>Score Types:</strong> band, percentage, points, grade
                        </p>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    <div
                        ...
                        :class="dragOver ? 'border-growth-600 bg-red-50 dark:bg-indigo-900/20' : 'border-gray-300 dark:border-gray-600'"
                    ...
                    >
                        ...
                        <div v-if="!form.file">
                            ...
                            <p class="mt-4 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <button
                                    ...
                                    class="text-growth-600 hover:text-indigo-700 dark:text-red-400 font-medium"
                                >
                                    browse
                                </button>
                            </p>
                        ...
                        <div v-else class="flex items-center justify-center space-x-3">
                            ...
                            <button
                                ...
                                class="text-red-600 hover:text-growth-700 dark:text-red-400"
                            >
...
const submit = () => {
    form.post(route('admin.data.language-tests.process-upload'), {
        forceFormData: true,
    });
};
</script>
