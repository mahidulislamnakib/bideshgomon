...
const form = useForm({
    language_id: props.languageTest.language_id || '',
    name: props.languageTest.name,
    name_bn: props.languageTest.name_bn,
    code: props.languageTest.code,
    min_score: props.languageTest.min_score,
    max_score: props.languageTest.max_score,
    score_type: props.languageTest.score_type,
    description: props.languageTest.description,
    is_active: props.languageTest.is_active,
});

const submit = () => {
    form.put(route('admin.data.language-tests.update', props.languageTest.id));
};
</script>
