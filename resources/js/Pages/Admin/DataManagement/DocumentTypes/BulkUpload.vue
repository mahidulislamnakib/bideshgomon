<template>
  <Head title="Bulk Upload Document Types" />
  <AdminLayout>
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Bulk Upload Document Types</h1>
        <p class="mt-1 text-sm text-gray-600">Upload multiple document types using CSV file</p>
      </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <div class="flex gap-2">
              <a :href="route('admin.data.document-types.template')" class="inline-flex items-center px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-md hover:bg-gray-200">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Empty Template
              </a>
              <a :href="route('admin.data.document-types.template', { with_sample: 1 })" class="inline-flex items-center px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-md hover:bg-gray-200">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
          ...
          <div class="space-y-4 text-sm">
            <div>
              ...
              <ul class="list-disc list-inside text-gray-600 space-y-1">
                <li><strong>name</strong> - Document type name (must be unique)</li>
                <li><strong>category</strong> - Category (travel, identity, financial, academic, employment, medical, legal)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside text-gray-600 space-y-1">
                <li><strong>name_bn</strong> - Name in Bengali</li>
                ...
                <li><strong>is_required</strong> - 1 (required) or 0 (optional), default: 0</li>
            ...
            <div class="bg-red-50 border border-red-200 rounded-md p-3">
              ...
              <ul class="list-disc list-inside text-brand-red-600 text-xs space-y-1">
                <li>Document names must be unique</li>
                <li>Category must match available options</li>
                <li>Required documents should be marked appropriately</li>
              </ul>
            </div>

            <div>
              <h3 class="font-medium text-gray-900 mb-2">Example CSV:</h3>
              <pre class="bg-gray-50 border border-gray-200 rounded p-2 text-xs overflow-x-auto">name,name_bn,category,is_required,sort_order,is_active
Passport,পাসপোর্ট,travel,1,1,1
National ID,জাতীয় পরিচয়পত্র,identity,1,2,1
Bank Statement,ব্যাংক স্টেটমেন্ট,financial,0,3,1</pre>
            </div>
          </div>
        </div>
      </div>
...
const submit = () => {
  form.post(route('admin.data.document-types.process-upload'), {
    onSuccess: () => {
      form.reset();
    },
  });
