<template>
    <AdminLayout>
        <Head title="Bulk Upload Cities" />

        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-6">
                    <Link :href="route('admin.data.cities.index')" class="text-sm text-growth-600 hover:text-red-900 dark:text-red-400 mb-2 inline-block">
                        ? Back to Cities
                    </Link>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Bulk Upload Cities</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Upload multiple cities at once using a CSV file</p>
                </div>
                ...
                <div class="bg-red-50 dark:bg-blue-900/20 border border-red-200 dark:border-blue-800 rounded-lg p-6 mb-6">
                    ...
                    <ol class="list-decimal list-inside space-y-2 text-sm text-growth-600 dark:text-blue-300">
                        ...
                        <li>Fill in your city data with valid country codes (e.g., BD, AE, GB)</li>
                        <li>Upload the completed CSV file</li>
                        <li>Review any errors and fix them</li>
                        <li>Successfully uploaded cities will appear in the list</li>
                    </ol>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">cities_template.csv</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">CSV template with sample data</p>
                        </div>
                        <a
                            :href="route('admin.data.cities-template')"
                    ...
                    <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded text-xs font-mono">country_code*</span>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">state_province</span>
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">timezone</span>
                            ...
                            <span class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded text-xs font-mono">is_capital</span>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-3">
                            <strong>Note:</strong> Use 2-letter country codes (BD, AE, GB, etc.). Coordinates must be valid decimals.
                        </p>
                    </div>
                </div>
...
const submit = () => {
    form.post(route('admin.data.cities-process-upload'), {
        forceFormData: true,
    });
};
</script>
