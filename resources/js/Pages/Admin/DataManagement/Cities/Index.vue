            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Cities Management</h1>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage all cities in the system</p>
                        </div>
                        <div class="flex items-center space-x-3">
                            ...
                            <Link
                                :href="route('admin.data.cities.create')"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <a
                            :href="route('admin.data.cities-export', form)"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="city in cities.data" :key="city.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ city.name }}</div>
                                            <div v-if="city.name_bn" class="text-sm text-gray-500 dark:text-gray-400">{{ city.name_bn }}</div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button
                                            ...
                                            :class="city.is_active ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'"
...
const filter = () => {
    router.get(route('admin.data.cities.index'), form, {
        preserveState: true,
        preserveScroll: true,
    });
};
...
const sortBy = (field) => {
    ...
    router.get(route('admin.data.cities.index'), {
        ...form,
        sort: field,
        direction,
    }, {
...
const toggleStatus = (city) => {
    if (confirm(`Are you sure you want to ${city.is_active ? 'deactivate' : 'activate'} ${city.name}?`)) {
        router.post(route('admin.data.cities.toggle-status', city.id), {}, {
            preserveScroll: true,
        });
    }
};
...
const deleteCity = (city) => {
    if (confirm(`Are you sure you want to delete ${city.name}? This action cannot be undone.`)) {
        router.delete(route('admin.data.cities.destroy', city.id), {
            preserveScroll: true,
        });
    }
};
