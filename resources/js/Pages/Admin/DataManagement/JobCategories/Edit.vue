                ...
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">URL-friendly identifier</p>
                        </div>
...
const form = useForm({
    ...
    name_bn: props.jobCategory.name_bn,
    slug: props.jobCategory.slug,
    description: props.jobCategory.description,
    order: props.jobCategory.order,
    is_active: props.jobCategory.is_active,
});

const submit = () => {
    form.put(route('admin.data.job-categories.update', props.jobCategory.id));
};
</script>
