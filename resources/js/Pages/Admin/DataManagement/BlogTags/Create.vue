<template>
  ...
  <AdminLayout>
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Add New Blog Tag</h1>
        <p class="mt-1 text-sm text-gray-600">Create a new blog tag</p>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        <form @submit.prevent="submit">
          <div class="mb-4">
            ...
            <input v-model="form.name" type="text" required class="w-full px-3 py-2 border rounded-md focus:ring-brand-red-600 focus:border-brand-red-600" :class="form.errors.name ? 'border-red-500' : 'border-gray-300'" placeholder="e.g., Work Visa"/>
...
const submit = () => {
  form.post(route('admin.data.blog-tags.store'));
};
</script>
