  ...
  <AdminLayout>
    <div class="p-6">
      ...
      <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        <div v-if="blogTag.posts_count > 0" class="mb-4 bg-red-50 border border-red-200 rounded-md p-3">
          <p class="text-sm text-brand-red-600">This tag is used in <strong>{{ blogTag.posts_count }}</strong> blog post(s).</p>
        </div>
