  ...
  <AdminLayout>
    <div class="p-6">
      ...
      <div class="mb-6 flex flex-col sm:flex-row gap-4">
        <Link :href="route('admin.data.degrees.create')" class="inline-flex items-center px-4 py-2 bg-growth-600 text-white text-sm font-medium rounded-md hover:bg-growth-700">
      ...
      <div class="mb-6 bg-white rounded-lg shadow p-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            ...
            <input v-model="filters.search" type="text" placeholder="Search degrees..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-growth-600 focus:border-growth-600" @input="debounceSearch"/>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Level</label>
            <select v-model="filters.level" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-growth-600 focus:border-growth-600" @change="applyFilters">
            ...
            <tr v-for="degree in degrees.data" :key="degree.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2 py-1 text-xs font-medium rounded-full" :class="{
                  'bg-red-100 text-growth-600': degree.level === 'Undergraduate',
                  'bg-purple-100 text-purple-800': degree.level === 'Graduate',
                  'bg-red-100 text-growth-600': degree.level === 'Postgraduate',
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <Link :href="route('admin.data.degrees.edit', degree.id)" class="text-growth-600 hover:text-red-900 mr-3">Edit</Link>
