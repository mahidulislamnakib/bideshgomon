        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Edit Blog Post</h2>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white rounded-lg shadow-sm p-6">
                                ...
                                <div class="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <div class="text-2xl font-bold text-blue-600">{{ post.views_count }}</div>
                                        <div class="text-sm text-gray-500">Views</div>
                                    </div>
                                    <div>
                                        <div class="text-2xl font-bold text-green-600">{{ post.reading_time || 0 }}</div>
                                        <div class="text-sm text-gray-500">Min Read</div>
                                    </div>
                                    <div>
                                        <div class="text-2xl font-bold text-purple-600">{{ post.tags ? post.tags.length : 0 }}</div>
...
const form = useForm({
    ...
    image_credit: props.post.image_credit || '',
    ...
    tags: props.post.tags ? props.post.tags.map(tag => tag.id) : [],
});

const originalSlug = props.post.slug;

const generateSlug = () => {
    if (!form.slug || form.slug === originalSlug || form.slug === slugify(props.post.title)) {
