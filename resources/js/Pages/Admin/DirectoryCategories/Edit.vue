                ...
                <div class="mb-6">
                    <div class="flex items-center mb-4">
                        <Link
                            ...
                            class="text-gray-600 hover:text-gray-900 dark:text-white mr-4"
                        >
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Directory Category</h2>
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                :value="category.slug"
                                type="text"
                                class="w-full rounded-xl border-gray-300 bg-gray-50 shadow-sm cursor-not-allowed"
                                readonly
                            />
                        ...
                        <div class="bg-gray-50 rounded-2xl p-4">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    <div class="text-2xl font-bold text-growth-600">{{ category.directories_count || 0 }}</div>
                                    <div class="text-xs text-gray-600">Directories</div>
                                </div>
                                <div>
                                    <div class="text-sm text-gray-600">Created</div>
                                    <div class="text-xs text-gray-500">{{ formatDate(category.created_at) }}</div>
                                </div>
                                <div>
                                    <div class="text-sm text-gray-600">Updated</div>
                                    <div class="text-xs text-gray-500">{{ formatDate(category.updated_at) }}</div>
                                </div>
                            </div>
                        </div>
...
const submit = () => {
    form.put(route('admin.directory-categories.update', props.category.id), {
        preserveScroll: true,
        onSuccess: () => {
