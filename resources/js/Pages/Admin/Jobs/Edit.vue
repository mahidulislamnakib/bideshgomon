        ...
        <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Job Posting</h1>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        required
                                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-growth-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        required
                                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-growth-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                    />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="flex gap-2 mb-2">
                                        <input
                                            ...
                                            class="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-growth-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Application Fee (?)</label>
                                    <input
                            ...
                            <div class="mt-6 space-y-3">
                                <label class="flex items-center">
                                    <input
                                        ...
                                        type="checkbox"
                                        class="h-4 w-4 text-growth-600 rounded border-gray-300 dark:border-gray-600 focus:ring-growth-600 bg-white dark:bg-gray-700"
                                    />
                        ...
                        <div class="flex items-center justify-end gap-4">
                            <Link
                                :href="route('admin.jobs.index')"
                                class="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-2xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                            >
                                Cancel
                            </Link>
                            <button
