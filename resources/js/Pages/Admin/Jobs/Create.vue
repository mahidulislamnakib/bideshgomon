                ...
                <div class="bg-white rounded-2xl shadow-sm p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="bg-red-50 border border-indigo-200 rounded-lg p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="w-full px-4 py-2 border border-indigo-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 font-semibold"
                                    />
                                </div>
