                ...
                <div class="md:flex md:items-center md:justify-between">
                        ...
                        <div class="flex items-center">
                            ...
                            <div v-else class="flex-shrink-0">
                                <div class="h-16 w-16 bg-ocean-100 rounded-lg flex items-center justify-center">
                                    <AcademicCapIcon class="h-8 w-8 text-ocean-600" />
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <div class="mt-4 flex md:mt-0 md:ml-4">
                        <a 
                            ...
                            target="_blank"
                            class="inline-flex items-center px-4 py-2 border border-ocean-300 rounded-md shadow-sm text-sm font-medium text-ocean-700 bg-white hover:bg-ocean-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ocean-500"
                        >
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-3">
                            <a 
                                ...
                                :href="university.website" 
                                target="_blank"
                                class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-ocean-600 hover:bg-ocean-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ocean-500"
                            >
                            ...
                            <Link
                                ...
                                class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ocean-500"
                            >
...
function getRankingColor(ranking) {
    ...
    if (ranking <= 50) return 'text-blue-600'
