            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <Link
                        ...
                        class="px-6 py-3 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition inline-flex items-center"
                    >
                ...
                <div v-else class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <Link
                        :href="route('flight-requests.create')"
                        class="inline-flex items-center px-6 py-3 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition"
                    >
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
