                ...
                <div v-else-if="error" class="bg-red-50 border border-red-200 rounded-lg p-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <button @click="fetchConfig" class="mt-4 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
                                Try Again
                            </button>
                        </div>
                    </div>
                        ...
                        <form @submit.prevent="handleNext">
                                            ...
                                            <div class="space-y-3">
                                                <label v-for="option in field.options" :key="option.value" class="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:border-ocean-400 transition"
                                                    ...
                                                    <div class="ml-3 flex-1">
                                                        ...
                                                        <div v-if="option.price" class="text-sm font-medium text-ocean-600 mt-1">
                                        ...
                                        <div v-else-if="field.type === 'checkbox'">
                                            <label class="flex items-start">
                                                <input
                                                    ...
                                                    v-model="form[field.name]"
                                                    :required="field.required"
                                                    class="mt-1 text-ocean-600 focus:ring-ocean-500 rounded"
                                                />
                            ...
                            <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
                                ...
                                <button
                                    v-if="currentStep < 5"
                                    type="submit"
                                    class="px-6 py-3 bg-ocean-600 text-white rounded-lg hover:bg-ocean-700 font-medium"
                                >
                                    Next Step
                                </button>
                                <button
