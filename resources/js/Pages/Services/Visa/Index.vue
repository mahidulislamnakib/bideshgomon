        ...
        <div class="min-h-screen bg-gray-50 dark:bg-neutral-900">
            ...
            <div class="bg-gradient-to-r from-growth-600 to-teal-600 px-4 py-6 sm:px-6">
                <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-white">Visa Application Services</h1>
                        <p class="text-sm text-white/80 mt-0.5">Professional visa assistance for multiple countries worldwide</p>
                    </div>
                    <Link
                        :href="route('visa.my-applications')"
                        class="px-4 py-2 bg-white text-growth-600 text-sm font-medium rounded-lg hover:bg-gray-100 transition-colors"
                    >
                        My Applications
                    </Link>
                </div>
                        ...
                        >
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <svg class="h-8 w-8" :class="selectedVisaType === type ? 'text-emerald-600' : 'text-emerald-600'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p v-if="selectedVisaType" class="text-sm text-gray-600 mt-1">
                                For <span class="font-semibold text-emerald-600">{{ visaTypes[selectedVisaType]?.name }}</span>
                            </p>
                        </div>
                        <Link
                            :href="route('visa.my-applications')"
                        ...
                        >
                            <div class="p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="text-2xl font-bold text-emerald-600">৳{{ country.service_fee.toLocaleString() }}</div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Link
                                        ...
                                        class="block w-full text-center px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition-colors"
                                    >
                                        Apply Now
                                    </Link>
                                </div>
                            ...
                            <div class="px-6 py-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div class="bg-ocean-50 rounded-lg p-4">
                                            ...
                                            <div class="text-2xl font-bold text-emerald-600">৳{{ ((selectedRequirements.government_fee || 0) + (selectedRequirements.service_fee || 0)).toLocaleString() }}</div>
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                                    <div v-if="selectedRequirements.interview_required" class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        <div class="flex items-start">
                                            <svg class="h-5 w-5 text-emerald-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="bg-gray-50 px-6 py-4 flex items-center justify-between">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <Link
                                        ...
                                        class="px-6 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700"
                                    >
                                        Apply Now
                                    </Link>
                                </div>
