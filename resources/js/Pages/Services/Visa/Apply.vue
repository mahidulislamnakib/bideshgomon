                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Country Code *</label>
                                <input
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Employer Name</label>
                                <input
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Issuing Country *</label>
                                <input
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Intended Travel Date *</label>
                                <input
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Travel Purpose *</label>
                                <textarea
