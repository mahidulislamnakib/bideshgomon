                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select v-model="form.visa_type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <select v-model="form.visa_category" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <select v-model="form.processing_type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-indigo-500">
