      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div class="flex items-start">
            <InformationCircleIcon class="h-5 w-5 text-growth-600 mt-0.5 mr-3 flex-shrink-0" />
            <div>
          ...
          >
            <label class="flex items-start">
              <input
                ...
                class="mt-1 rounded border-gray-300 text-growth-600 shadow-sm focus:border-primary-500 focus:ring-growth-600"
              />
              <span class="ml-3">
