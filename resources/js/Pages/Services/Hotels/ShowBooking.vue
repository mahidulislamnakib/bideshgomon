    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-6">
                    <Link :href="route('hotels.my-bookings')" class="text-growth-600 hover:text-indigo-800">
                        ← Back to My Bookings
                    </Link>
                </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link v-if="booking.status === 'confirmed' || booking.status === 'checked_in'" 
                                ...
                                class="flex-1 bg-growth-600 text-white py-3 px-6 rounded-lg hover:bg-growth-700 transition text-center">
                                View Hotel
                            </Link>
                        </div>
                    </div>
                        ...
                        <form @submit.prevent="cancelBooking">
                            <div class="mb-4">
                                ...
                                <textarea v-model="cancelForm.reason" rows="3" required
                                    class="w-full border-gray-300 rounded-lg focus:ring-growth-600 focus:border-growth-600"
