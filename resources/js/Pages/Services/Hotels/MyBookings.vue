            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8 flex justify-between items-center">
                    ...
                    <Link :href="route('hotels.index')" 
                        class="bg-growth-600 text-white px-6 py-2 rounded-lg hover:bg-growth-700 transition">
                        + Book New Hotel
                    </Link>
                </div>
                            ...
                            <div class="md:w-3/4 p-6">
                                ...
                                <div class="flex justify-between items-center pt-4 border-t">
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-growth-600">{{ formatPrice(booking.total_amount) }}</p>
                                    </div>
                ...
                <div v-else class="bg-white rounded-lg shadow-md p-12 text-center">
                    ...
                    <Link :href="route('hotels.index')" 
                        class="mt-6 inline-block bg-growth-600 text-white px-6 py-3 rounded-lg hover:bg-growth-700 transition">
                        Browse Hotels
                    </Link>
                </div>
