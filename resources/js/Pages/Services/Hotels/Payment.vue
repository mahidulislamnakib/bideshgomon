        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <!-- Header -->
                    <div class="bg-growth-600 text-white p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="border-t pt-3 flex justify-between items-center">
                                    ...
                                    <span class="text-2xl font-bold text-growth-600">{{ formatPrice(booking.total_amount) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="processPayment">
                            <div class="mb-8">
                                ...
                                <div class="space-y-3">
                                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition"
                                        ...
                                        <input v-model="form.payment_method" type="radio" value="wallet" class="text-growth-600 focus:ring-growth-600" />
                                    ...
                                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition"
                                        ...
                                        <input v-model="form.payment_method" type="radio" value="card" class="text-growth-600 focus:ring-growth-600" />
                                        <div class="ml-3 flex-1">
                                    ...
                                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition"
                                        ...
                                        <input v-model="form.payment_method" type="radio" value="cash" class="text-growth-600 focus:ring-growth-600" />
                                        <div class="ml-3 flex-1">
                            ...
                            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <div class="flex items-start">
                                    <svg class="w-5 h-5 text-growth-600 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <button type="submit" :disabled="form.processing"
                                    class="flex-1 bg-growth-600 text-white py-3 px-6 rounded-lg hover:bg-growth-700 transition disabled:opacity-50 disabled:cursor-not-allowed">
