                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <label v-for="consultant in consultants" :key="consultant.id" class="relative flex cursor-pointer rounded-lg border-2 p-4 focus:outline-none" :class="form.consultant_id === consultant.id ? 'border-ocean-600 bg-ocean-50 dark:bg-ocean-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-ocean-300'">
                                    ...
                                    <div class="flex items-center gap-3 flex-1">
                                        ...
                                        <CheckCircleIcon v-if="form.consultant_id === consultant.id" class="h-6 w-6 text-growth-600 flex-shrink-0" />
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                            ...
                            <div class="grid grid-cols-7 gap-2 mb-4">
                                ...
                                <button v-for="(day, index) in calendarDays" :key="index" @click="selectDate(day)" type="button" :disabled="!day.isCurrentMonth || day.isPast || !day.hasSlots" class="aspect-square p-2 rounded-lg text-sm font-medium transition-colors relative" :class="{
                                    ...
                                    'bg-growth-600 text-white': selectedDate === day.dateStr,
                                    ...
                                    {{ day.day }}
                                    <span v-if="day.hasSlots && selectedDate !== day.dateStr" class="absolute bottom-1 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-growth-600 rounded-full"></span>
                                </button>
                            </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 sticky top-4">
                                ...
                                <div class="space-y-2">
                                    <label class="relative flex cursor-pointer rounded-lg border-2 p-3 focus:outline-none" :class="form.appointment_type === 'online_meeting' ? 'border-ocean-600 bg-ocean-50 dark:bg-ocean-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-ocean-300'">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <CheckCircleIcon v-if="form.appointment_type === 'online_meeting'" class="h-5 w-5 text-growth-600 ml-auto" />
                                        </div>
                                    </label>
                                    <label class="relative flex cursor-pointer rounded-lg border-2 p-3 focus:outline-none" :class="form.appointment_type === 'office_visit' ? 'border-ocean-600 bg-ocean-50 dark:bg-ocean-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-ocean-300'">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <CheckCircleIcon v-if="form.appointment_type === 'office_visit'" class="h-5 w-5 text-growth-600 ml-auto" />
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <select v-model="form.purpose" id="purpose" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-growth-600 focus:border-ocean-500">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea v-model="form.notes" id="notes" rows="3" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-growth-600 focus:border-ocean-500" placeholder="Tell us about your travel plans..."></textarea>
                            </div>
                            ...
                            <!-- Submit Button -->
                            <button @click="submit" type="button" :disabled="!form.consultant_id || !selectedDate || !selectedTime || form.processing" class="w-full bg-growth-600 text-white px-4 py-3 rounded-lg hover:bg-growth-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed">
