...
<template>
    ...
    <AuthenticatedLayout>
        <div class="min-h-screen bg-gray-50 pb-20">
            <!-- Header -->
            <div class="bg-growth-600 text-white px-4 pt-6 pb-24">
            ...
            <div class="max-w-4xl mx-auto px-4 -mt-16 space-y-4">
                ...
                <div class="bg-white rounded-2xl p-5 shadow-xl mb-4">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <div class="text-xl font-bold text-growth-600">
                    ...
                    <div class="flex items-center justify-between">
                        <div v-for="step in 3" :key="step" class="flex-1 flex items-center">
                            <div class="flex items-center space-x-2">
                                <div 
                                    :class="[
                                        ...
                                        currentStep >= step ? 'bg-growth-600 text-white' : 'bg-gray-200 text-gray-500'
                                    ]"
                                >
                            ...
                            <div 
                                ...
                                :class="[
                                    'flex-1 h-1 mx-2',
                                    currentStep > step ? 'bg-growth-600' : 'bg-gray-200'
                                ]"
                            ></div>
                        </div>
                    </div>
                ...
                <div v-show="currentStep === 1" class="bg-white rounded-2xl p-6 shadow-lg">
                    <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                        <UserIcon class="h-6 w-6 mr-2 text-growth-600" />
                    ...
                    <button
                        @click="nextStep"
                        class="w-full mt-6 bg-growth-600 text-white py-4 rounded-xl font-semibold hover:bg-growth-700 transition-all"
                    >
                ...
                <div v-show="currentStep === 2" class="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <div class="flex space-x-3 mt-6">
                        ...
                        <button
                            @click="nextStep"
                            class="flex-1 bg-growth-600 text-white py-4 rounded-xl font-semibold hover:bg-growth-700 transition-all"
                        >
                            Continue to Payment
                        </button>
                    </div>
                ...
                <div v-show="currentStep === 3" class="space-y-4">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="pt-3 border-t-2 border-gray-200 flex justify-between">
                                ...
                                <span class="text-2xl font-bold text-growth-600">{{ formatCurrency(totalAmount) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button
                            ...
                            class="flex-1 bg-growth-600 hover:bg-growth-700 text-white py-4 rounded-xl font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
