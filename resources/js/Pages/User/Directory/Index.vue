                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-4">
                        ...
                        <div class="mb-6">
                            ...
                            <select
                                ...
                                class="w-full rounded-lg border-gray-300 focus:border-growth-600 focus:ring-growth-600 shadow-sm"
                            >
                        ...
                        <div class="mt-6 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                            <div class="flex gap-3">
                                <svg class="h-5 w-5 text-growth-600 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div v-if="directories.data.length > 0 && viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <div class="p-5 flex flex-col flex-grow">
                                <!-- Name -->
                                <h3 class="text-base font-bold text-gray-900 mb-3 group-hover:text-growth-600 transition-colors line-clamp-2 leading-tight h-[48px] overflow-hidden">
                                    {{ directory.name }}
                                </h3>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                                    ...
                                    <span class="inline-flex items-center gap-1.5 text-growth-600 text-sm font-semibold group-hover:gap-2 transition-all">
                                        Details
                                ...
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3 mb-2">
                                            <h3 class="text-xl font-bold text-gray-900 group-hover:text-growth-600 transition-colors">
                                                {{ directory.name }}
                                            </h3>
                                            <span
                    ...
                    <div v-else class="text-center py-20">
                        ...
                        <div class="flex items-center justify-center gap-3">
                            <button
                                @click="clearFilters"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-growth-600 text-white rounded-xl hover:bg-growth-700 transition-colors font-semibold shadow-lg shadow-blue-500/30"
                            >
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                </svg>
