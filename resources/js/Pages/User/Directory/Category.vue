    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <nav class="flex items-center gap-2 text-sm text-gray-600 mb-8">
                <Link :href="route('directory.index')" class="hover:text-growth-600">Directory</Link>
            ...
            <div v-if="directories.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                >
                    ...
                    <div class="p-5">
                        <!-- Name -->
                        <h3 class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-growth-600 transition-colors line-clamp-2">
                            {{ directory.name }}
                        </h3>
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                            ...
                            <span class="text-growth-600 text-sm font-medium group-hover:underline">
                                View Details →
                            </span>
                        </div>
                    </div>
            ...
            <div v-else class="text-center py-12">
                ...
                <Link
                    ...
                    class="inline-flex items-center px-4 py-2 bg-growth-600 text-white rounded-lg hover:bg-growth-700 transition-colors"
                >
