    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="bg-growth-600 overflow-hidden shadow-sm sm:rounded-lg mb-6 p-8 text-white">
                ...
                <div v-if="featuredEvents.length > 0 && selectedTime === 'upcoming'" class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                            ...
                            <div v-else class="h-48 bg-growth-600 flex items-center justify-center">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        ...
                        <div class="flex gap-2 mt-4">
                            <button
                                @click="applyFilters"
                                class="px-4 py-2 bg-growth-600 text-white rounded-md hover:bg-growth-700"
                            >
                                Search
                            </button>
                            <button
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div v-if="events.data.length === 0" class="text-center py-12">
                            ...
                            <button
                                @click="clearFilters"
                                class="mt-4 text-growth-600 hover:text-blue-700 font-medium"
                            >
