            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <Link
                        ...
                        class="inline-flex items-center text-growth-600 hover:text-blue-700"
                    >
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <div v-else class="h-96 bg-growth-600 flex items-center justify-center">
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                                        <svg class="w-6 h-6 text-growth-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        <div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg sticky top-6">
                            <div class="p-6">
                                ...
                                <div v-if="isUpcoming() && !hasRegistrationClosed()">
                                    <div class="bg-growth-600 text-white p-4 rounded-lg mb-4 text-center">
                                        <div class="text-3xl font-bold">{{ getDaysUntilEvent() }}</div>
                                        <div class="text-sm">{{ getDaysUntilEvent() === 1 ? 'Day' : 'Days' }} Until Event</div>
                                    </div>
                                    
                                    <button
                                        class="w-full px-4 py-3 bg-growth-600 text-white rounded-lg hover:bg-growth-700 font-semibold transition-colors"
                                    >
                                ...
                                <div v-if="event.is_online && event.meeting_link && isUpcoming()" class="mt-4 pt-4 border-t border-gray-200">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        class="block text-growth-600 hover:text-blue-700 text-sm break-all underline"
                                    >
                                        {{ event.meeting_link }}
                                    </a>
                                </div>
                                ...
                                <div class="mt-6 pt-4 border-t border-gray-200">
                                    ...
                                    <div class="flex gap-2">
                                        <button class="flex-1 px-3 py-2 bg-blue-50 text-growth-600 rounded hover:bg-blue-100 text-sm">
                                            Facebook
                                        </button>
                                        <button class="flex-1 px-3 py-2 bg-cyan-50 text-growth-600 rounded hover:bg-cyan-100 text-sm">
                                            Twitter
                                        </button>
                        ...
                        <div class="bg-blue-50 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <Link
                                    ...
                                    class="inline-flex items-center text-growth-600 hover:text-blue-700 text-sm font-medium"
                                >
                                    Contact Support
