      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 mb-6">
        ...
        <div class="space-y-4 mb-8">
          <div class="flex items-start space-x-3">
            <svg class="w-5 h-5 text-growth-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          :disabled="isRetrying"
          class="w-full flex items-center justify-center px-6 py-3 bg-growth-600 text-white font-medium rounded-lg hover:bg-growth-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
