                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="flex-shrink-0">
                                        <img 
                                            v-if="photoPreview || teamMember.photo" 
                                            :src="photoPreview || `/storage/${teamMember.photo}`" 
                                            alt="Photo"
...
const form = useForm({
    ...
    years_experience: props.teamMember.years_experience,
    languages: props.teamMember.languages && props.teamMember.languages.length > 0 ? props.teamMember.languages : [''],
    qualifications: props.teamMember.qualifications && props.teamMember.qualifications.length > 0 ? props.teamMember.qualifications : [''],
    is_visible: props.teamMember.is_visible,
});
...
const submit = () => {
    form.post(route('agency.team.update', props.teamMember.id), {
        preserveScroll: true,
        forceFormData: true,
        _method: 'PUT',
    });
