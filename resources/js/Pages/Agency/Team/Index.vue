                    ...
                    <div class="p-6">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <Link :href="route('agency.team.create')" class="inline-flex items-center px-3 sm:px-4 py-2 bg-growth-600 text-white text-sm rounded-md hover:bg-growth-700">
                        ...
                        <div v-if="teamMembers.length === 0" class="text-center py-12">
                            ...
                            <div class="mt-6 flex flex-col sm:flex-row justify-center gap-3">
                                ...
                                <Link :href="route('agency.team.create')" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-growth-600 hover:bg-growth-700">
                                ...
                                <template #item="{element}">
                                    <div class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-move">
                                        ...
                                        <div class="mt-4 flex items-center justify-between">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <Link :href="route('agency.team.edit', element.id)" class="text-growth-600 hover:text-red-900">
