          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="flex items-start gap-3">
              <div class="flex-shrink-0 p-2 bg-blue-100 rounded-lg">
                <UserIcon class="h-5 w-5 text-growth-600" />
              </div>
              <div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                min="0"
                required
                class="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-growth-600 focus:border-growth-600"
                placeholder="0.00"
              />
            </div>
