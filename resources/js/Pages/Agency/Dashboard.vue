                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            ...
                            <Link
                                ...
                                class="inline-flex items-center justify-center px-4 py-2 bg-growth-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-growth-700"
                            >
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-3 sm:mb-4">
                            <div class="bg-blue-100 p-2 sm:p-3 rounded-lg">
                                <DocumentTextIcon class="w-5 h-5 sm:w-6 sm:h-6 text-growth-600" />
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div class="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
                        ...
                        <Link
                            ...
                            class="inline-flex items-center text-xs sm:text-sm font-medium text-growth-600 hover:text-indigo-700 mt-3 sm:mt-4"
                        >
                                ...
                                <div v-for="app in availableApplications" :key="app.id" class="border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-indigo-300 hover:bg-indigo-50/50 transition-colors">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <Link
                                            ...
                                            class="inline-flex items-center text-xs sm:text-sm font-medium text-growth-600 hover:text-indigo-700"
                                        >
