          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-start justify-between">
              <div class="flex-shrink-0 p-3 bg-blue-100 rounded-lg">
                <ClockIcon class="h-6 w-6 text-growth-600" />
              </div>
            </div>
            <div class="mt-4">
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-start justify-between">
              <div class="flex-shrink-0 p-3 bg-indigo-100 rounded-lg">
                <ChartBarIcon class="h-6 w-6 text-growth-600" />
              </div>
            </div>
            <div class="mt-4">
              ...
              >
                <div class="flex items-center gap-3">
                  <div class="flex-shrink-0 w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span class="text-sm font-bold text-growth-600">{{ index + 1 }}</span>
                  </div>
                  <div>
                ...
                <tr v-for="payment in pendingPayments" :key="payment.id" class="hover:bg-gray-50">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <Link
                      ...
                      class="text-sm font-medium text-growth-600 hover:text-red-900"
                    >
