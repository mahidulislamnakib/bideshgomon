                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <BuildingOfficeIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Business Information
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input 
                                    ...
                                    type="text" 
                                    required
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-growth-600 focus:ring-growth-600" 
                                />
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    type="date" 
                                    class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-growth-600 focus:border-growth-600 transition-all" 
                                />
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea 
                                    ...
                                    class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-growth-600 focus:border-growth-600 transition-all resize-none"
                                ></textarea>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <TagIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Agency Type *
                        </h3>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <ClipboardDocumentListIcon class="h-5 w-5 mr-2 text-growth-600" />
                                Services Offered
                            </h3>
                            ...
                            <div v-for="(services, category) in serviceModules" :key="category" class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <button 
                                        ...
                                        class="text-xs text-growth-600 hover:text-indigo-700 font-medium"
                                    >
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <PhotoIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Agency Logo
                        </h3>
                        <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                            ...
                            <div class="flex-1">
                                ...
                                <p v-if="logoUploading" class="mt-1 text-sm text-growth-600">Uploading...</p>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <PhoneIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Contact Information
                        </h3>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <GlobeAltIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Social Media Links
                        </h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <MapIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Countries Expertise
                        </h3>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <LanguageIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Languages Spoken
                        </h3>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <UserGroupIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Team Information
                        </h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <CameraIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Office Images
                        </h3>
                        ...
                        <div>
                            ...
                            <p v-if="imagesUploading" class="mt-1 text-sm text-growth-600">Uploading...</p>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <ChartBarIcon class="h-5 w-5 mr-2 text-growth-600" />
                            Statistics
                        </h3>
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                            <MagnifyingGlassIcon class="h-5 w-5 mr-2 text-growth-600" />
                            SEO & Marketing
                        </h3>
                        <div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        <button 
                            ...
                            class="px-6 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-growth-600 hover:bg-growth-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-growth-600 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
